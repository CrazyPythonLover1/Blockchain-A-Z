...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Kalam', amount = 1)
...
def replace_chain():
    ...
    if is_chain_replaced:
        ...
        response = {'message': 'All good. The chain is the largest one', 'new_chain': blockchain.chain}
    return jsonify(response), 200
